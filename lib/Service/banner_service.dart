...
class BannerService {
  final bannersRef = FirebaseFirestore.instance.collection('banners').withConverter<CarouselModel>(fromFirestore: (snapshot, _) => CarouselModel.fromJson(snapshot.data()!), toFirestore: (movie, _) => movie.toJson(),
